<?php $__env->startSection('title', 'Show notification_systems'); ?>
...
<main id="main" class="main position-absolute">
    ...
    <div class="pagetitle">
        <div class="d-flex justify-content-between align-items-center my-3">
            ...
            <a href="<?php echo e(route('Dashboard.notification_system.create')); ?>" class="btn btn-primary" style="
">add
        ...
        <div class="card">
            <div class="card-body right-thead">
                <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <?php if($page == 'index'): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notification_system.index')): ?>
                    <a href="<?php echo e(route('Dashboard.notification_system.trash')); ?>" class="btn btn-outline-danger" style="
                                  ">
                    ...
                    <?php else: ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notification_system.index')): ?>
                    <a href="<?php echo e(route('Dashboard.notification_system.index')); ?>" class="btn btn-outline-primary">
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','value' => '','name' => 'notification','id' => 'notification','title' => 'search']); ?>
...
<?php endif; ?>
                    ...
                    <tbody id="tableContainer">
                        <?php echo $__env->make('Dashboard.Notification_System.table', ['notification_system' => $notification_systems,
                        'page' => $page], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </tbody>
                </table>
<?php echo e($notification_systems->links()); ?>
...
$('#printExcelReport').on('click', function () {
    ...
    window.open("<?php echo e(route('Dashboard.notification_system.exportExcel')); ?>?" + query, '_blank');
});
...
$('#printPdfReport').on('click', function () {
    let query = $.param(datavalue());
    // فتح رابط الطباعة مع تمرير الفلاتر
    window.open("<?php echo e(route('Dashboard.notification_system.exportPDF')); ?>?" + query, '_blank');
});
    ...
    $('#searchBtn').on('click', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('Dashboard.notification_system.search')); ?>",
            type: "GET",
            data: data,
...
<?php echo $__env->make('Dashboard.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Parking_System\resources\views/Dashboard/Notification_System/index.blade.php ENDPATH**/ ?>