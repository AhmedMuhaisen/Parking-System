...
<head>
    ...
    <!-- Favicons -->
    <link href="<?php echo e(asset('assets/Dashboard/img/favicon.png')); ?>" rel="icon">
    <link href="<?php echo e(asset('assets/Dashboard/img/apple-touch-icon.png')); ?>" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="<?php echo e(asset('assets/Dashboard/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/Dashboard/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/Dashboard/vendor/boxicons/css/boxicons.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/Dashboard/vendor/quill/quill.snow.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/Dashboard/vendor/quill/quill.bubble.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/Dashboard/vendor/remixicon/remixicon.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/Dashboard/vendor/simple-datatables/style.css')); ?>" rel="stylesheet">
...
<body style="direction: ltr">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav3" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.category.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all Category</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.category.create')); ?>">
                            <i class="bi bi-circle"></i><span>create Category</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.category.trash')); ?>">
                ...
                <ul id="vehicles-management" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        ...
                        <ul id="vehicle-types" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.vehiclesType.index')); ?>"><i class="bi bi-circle"></i> Show
                                    All</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehiclesType.create')); ?>"><i class="bi bi-circle"></i>
                                    Create</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehiclesType.trash')); ?>"><i class="bi bi-circle"></i>
                                    Trashed</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="vehicle-brands" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.vehiclesBrand.index')); ?>"><i class="bi bi-circle"></i> Show
                                    All</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehiclesBrand.create')); ?>"><i class="bi bi-circle"></i>
                                    Create</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehiclesBrand.trash')); ?>"><i class="bi bi-circle"></i>
                                    Trashed</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="vehicles" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.vehicle.index')); ?>"><i class="bi bi-circle"></i> Show
                                    All</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehicle.create')); ?>"><i class="bi bi-circle"></i>
                                    Create</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehicle.trash')); ?>"><i class="bi bi-circle"></i>
                                    Trashed</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="vehicle-movements" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.vehicleMovement.index')); ?>"><i class="bi bi-circle"></i>
                                    Show All</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehicleMovement.create')); ?>"><i class="bi bi-circle"></i>
                                    Create</a></li>
                            <li><a href="<?php echo e(route('Dashboard.vehicleMovement.trash')); ?>"><i class="bi bi-circle"></i>
                                    Trashed</a></li>
                        </ul>
                    </li>
                        ...
                        <ul id="login_attempts" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.login_attempt.index')); ?>"><i class="bi bi-circle"></i>
                                    Show All</a></li>
                            <li><a href="<?php echo e(route('Dashboard.login_attempt.create')); ?>"><i class="bi bi-circle"></i>
                                    Create</a></li>
                            <li><a href="<?php echo e(route('Dashboard.login_attempt.trash')); ?>"><i class="bi bi-circle"></i>
                                    Trashed</a></li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav10" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('Dashboard.user.create')); ?>">
                            <i class="bi bi-circle"></i><span>create user</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.user.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav13" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.parking.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all parking</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.parking.create')); ?>">
                            <i class="bi bi-circle"></i><span>create parking</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.parking.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav14" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.building.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all building</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.building.create')); ?>">
                            <i class="bi bi-circle"></i><span>create building</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.building.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav15" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.unit.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all unit</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.unit.create')); ?>">
                            <i class="bi bi-circle"></i><span>create unit</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.unit.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav16" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.gate.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all gate</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.gate.create')); ?>">
                            <i class="bi bi-circle"></i><span>create gate</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.gate.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav18" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.spot.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all Spots</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.spot.create')); ?>">
                            <i class="bi bi-circle"></i><span>create Spot</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.spot.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav19" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.guest.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all guests</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.guest.create')); ?>">
                            <i class="bi bi-circle"></i><span>create guest</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.guest.trash')); ?>">
     ...
     <li class="nav-item">
                ...
                <ul id="components-nav21" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('Dashboard.message.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav20" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.camera.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all cameras</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.camera.create')); ?>">
                            <i class="bi bi-circle"></i><span>create camera</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.camera.trash')); ?>">
                ...
                <ul id="components-nav21" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('Dashboard.testimonial.create')); ?>">
                            <i class="bi bi-circle"></i><span>create testimonial</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.testimonial.trash')); ?>">
          ...
          <li class="nav-item">
                ...
                <ul id="components-nav23" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.notification_rule.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all notification_rules</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.notification_rule.create')); ?>">
                            <i class="bi bi-circle"></i><span>create notification_rule</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.notification_rule.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav17" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo e(route('Dashboard.register_request.index')); ?>">
                            <i class="bi bi-circle"></i><span>show all register_request</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Dashboard.register_request.create')); ?>">
                            <i class="bi bi-circle"></i><span>create register_request</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('Dashboard.register_request.trash')); ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav170" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                      ...
                      <li><a href="<?php echo e(route('Dashboard.setting')); ?>"> <i class="bi bi-circle"></i><span>setting</span></a></li>
                    ...
                    <li>
                        ...
                        <ul id="components-nav171" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.role.index')); ?>"><span>Show All Roles</span></a></li>
                            <li><a href="<?php echo e(route('Dashboard.role.create')); ?>"><span>Create Role</span></a></li>
                            <li><a href="<?php echo e(route('Dashboard.role.trash')); ?>"><span>Trashed Roles</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="components-nav172" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.permission.index')); ?>"><span>Show All
                                        Permissions</span></a></li>
                            <li><a href="<?php echo e(route('Dashboard.permission.create')); ?>"><span>Create Permission</span></a>
                            </li>
                            <li><a href="<?php echo e(route('Dashboard.permission.trash')); ?>"><span>Trashed Permissions</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="components-nav173" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.user_role.index')); ?>"><span>Show All User Roles</span></a>
                            </li>
                            <li><a href="<?php echo e(route('Dashboard.user_role.create')); ?>"><span>Create User Role</span></a>
                            </li>
                            <li><a href="<?php echo e(route('Dashboard.user_role.trash')); ?>"><span>Trashed User Roles</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="components-nav174" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.color.index')); ?>"><span>Show All colors</span></a></li>
                            <li><a href="<?php echo e(route('Dashboard.color.create')); ?>"><span>Create color</span></a></li>
                            <li><a href="<?php echo e(route('Dashboard.color.trash')); ?>"><span>Trashed colors</span></a></li>
                        </ul>
            ...
            <li>
                        ...
                        <ul id="components-nav176" class="nav-content collapse">
                            <li><a href="<?php echo e(route('Dashboard.parking_work.index')); ?>"><span>Show All parking_works</span></a></li>
                            <li><a href="<?php echo e(route('Dashboard.parking_work.create')); ?>"><span>Create parking_work</span></a></li>
                            <li><a href="<?php echo e(route('Dashboard.parking_work.trash')); ?>"><span>Trashed parking_works</span></a></li>
                        </ul>
    ...
    <!-- Vendor JS Files -->
    <script src="<?php echo e(asset('assets/Dashboard/vendor/apexcharts/apexcharts.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/Dashboard/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/Dashboard/vendor/chart.js/chart.umd.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/Dashboard/vendor/echarts/echarts.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/Dashboard/vendor/quill/quill.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/Dashboard/vendor/simple-datatables/simple-datatables.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/Dashboard/vendor/tinymce/tinymce.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/Dashboard/vendor/php-email-form/validate.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\Parking_System\resources\views/Dashboard/main.blade.php ENDPATH**/ ?>