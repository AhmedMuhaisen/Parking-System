<?php $__env->startSection('title', 'Show Vehicles_types'); ?>
...
<main id="main" class="main position-absolute">
    ...
    <div class="pagetitle">
        <div class="d-flex justify-content-between align-items-center my-3">
            ...
            <a href="<?php echo e(route('Dashboard.vehiclesType.create')); ?>" class="btn btn-primary" style="
">add
                new vehiclesType</a>
        </div>
    </div><!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body right-thead">
                <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <?php if($page == 'index'): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vehiclesType.index')): ?>
                    <a href="<?php echo e(route('Dashboard.vehiclesType.trash')); ?>" class="btn btn-outline-danger" style="
                                  ">
                    ...
                    <?php else: ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vehiclesType.index')): ?>
                    <a href="<?php echo e(route('Dashboard.vehiclesType.index')); ?>" class="btn btn-outline-primary">
...
<?php $attributes = $attributes->except(\App\View\Components\Input::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','value' => '','title' => 'vehicles number','name' => 'vehicles_number','id' => 'vehicles_number']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal786b6632e4e03cdf0a10e8880993f28a)): ?>
<?php $attributes = $__attributesOriginal786b6632e4e03cdf0a10e8880993f28a; ?>
...
<?php endif; ?>
                 ...
                 <?php echo $__env->make('Dashboard.VehiclesType.table', ['vehiclesType' => $vehiclesType, 'page' => $page], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </tbody>
                </table>
...
$('#printExcelReport').on('click', function () {
    ...
    window.open("<?php echo e(route('Dashboard.vehiclesType.exportExcel')); ?>?" + query, '_blank');
});
...
$('#printPdfReport').on('click', function () {
    let query = $.param(datavalue());
    // فتح رابط الطباعة مع تمرير الفلاتر
    window.open("<?php echo e(route('Dashboard.vehiclesType.exportPDF')); ?>?" + query, '_blank');
});
    ...
    $('#searchBtn').on('click', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('Dashboard.vehiclesType.search')); ?>",
            type: "GET",
            data: data,
...
<?php echo $__env->make('Dashboard.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Parking_System\resources\views/Dashboard/VehiclesType/index.blade.php ENDPATH**/ ?>