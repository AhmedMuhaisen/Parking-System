                        ...
                        <tr>
                            ...
                            <td width=""><?php echo e($item->name); ?></td>
                              <td width="200"><?php echo $item->description; ?></td>
                            <td width=""><?php echo e($item->work_method); ?></td>
                            <td width=""><?php echo e($item->status); ?></td>
                            <td width=""><?php echo e($item->created_at->format('m-d-Y')); ?></td>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href=<?php if($page=='trash'
                                        ): ?> "<?php echo e(route('Dashboard.category.restore', $item->id)); ?>"
                                        <?php else: ?> "<?php echo e(route('Dashboard.category.edit', $item->id)); ?>" <?php endif; ?>>
                                    ...
                                    <form
                                        action="<?php if($page == 'trash'): ?> <?php echo e(route('Dashboard.category.forcedelete', $item->id)); ?><?php else: ?><?php echo e(route('Dashboard.category.destroy', $item->id)); ?> <?php endif; ?>"
                                        method="post">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Parking_System\resources\views/Dashboard/Category/table.blade.php ENDPATH**/ ?>