...
class VehiclesBrandsExport implements FromCollection, WithHeadings, WithEvents, WithCustomStartCell,WithMapping,WithColumnWidths
{
    ...
    {
     $vehiclesBrands=VehiclesBrand::search($this->request);

    return $vehiclesBrands->get();
 ...
 public function map($vehiclesBrand): array
    {
        return [
            $vehiclesBrand->id,
            $vehiclesBrand->name,
  ...
  $sheet->mergeCells('A4:E4');
                $sheet->setCellValue('A4', 'vehiclesBrands Report');
