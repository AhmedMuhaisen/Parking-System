    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body create-notification_rule">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a class="role-back btn btn-primary w-20 h-75"
                        href="{{ route('Dashboard.notification_rule.index') }}"> Rol
                        Back</a>
                </div>
            ...
            @enderror">
                        ...
                        <option value="{{ $user->id }}" {{old('user_id',$notification_rule->user_id) == $user->id ?
            ...
            @enderror">Channels</label><br>
                    ...
                    <label class="pretty-checkbox">
                        <input type="checkbox" name="channels[]" value="{{ $channel }}" {{ isset($notification_rule) &&
            ...
            @enderror">Additional</label><br>
                    ...
                    <label class="pretty-checkbox">
                        <input type="checkbox" name="additional[]" value="{{ $additional }}" {{
                            isset($notification_rule) && in_array($additional,
            ...
            @enderror">Actions</label><br>
                    ...
                    <label class="pretty-checkbox">
                        <input type="checkbox" name="actions[]" value="{{ $action }}" {{ isset($notification_rule) &&
