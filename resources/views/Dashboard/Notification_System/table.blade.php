                        ...
                        @forelse ($notification_systems as $item)
                        <tr>
                            ...
                            {{-- <td>
                                <div class="d-flex">
                                    <a href=@if ($page=='trash'
                                        ) "{{ route('Dashboard.notification_system.restore', $item->id) }}"
                                        @else "{{ route('Dashboard.notification_system.edit', $item->id) }}" @endif>
                                    ...
                                    <form
                                        action="@if ($page == 'trash') {{ route('Dashboard.notification_system.forcedelete', $item->id) }}@else{{ route('Dashboard.notification_system.destroy', $item->id) }} @endif"
                                        method="post">
                                        @csrf
                                        @method('delete')
